...
class App extends Component {
  ...
  initMap() {
    ...
    let mapOptions = {
      center: { lat: 25.699502, lng: 32.6390509 },
      zoom: 13,
      styles: mapStyle,
      ...
      <div>
        <header className="header">
          <h3 tabIndex="0" className="title">
            <span className="title--bold">Best places in:</span>Luxor, Egypt<span> "All Data Coming from wikipedia.org"</span>
          </h3>
        </header>
        ...
        <div
          id="map"
          role="application"
          aria-label="Best Places In Luxor - Egypt"
          tabIndex="0"
        />
      </div>
    ) : (
...
export default scriptLoader([
  `https://maps.googleapis.com/maps/api/js?key=AIzaSyAyykNsmP0ktMt-f_8u7K_sh3lktzPWjdo&v=3`
])(App);
